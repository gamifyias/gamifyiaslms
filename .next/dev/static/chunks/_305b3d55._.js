...
function AdminSubjectsPage() {
    ...
    // -----------------------------------
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminSubjectsPage.useEffect": ()=>{
            const load = {
                "AdminSubjectsPage.useEffect.load": async ()=>{
                    try {
                        setLoading(true);
                        const { data: { user } } = await supabase.auth.getUser();
            ...
            }["AdminSubjectsPage.useEffect.load"];
            load();
        }
    }["AdminSubjectsPage.useEffect"], []);
    // ------------------------------------------
...
_s(AdminSubjectsPage, "3c5hGduSkP+KI3yzKTisg0k6jsk=", false, function() {
    return [
...
_c = AdminSubjectsPage;
var _c;
__turbopack_context__.k.register(_c, "AdminSubjectsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_305b3d55._.js.map