...
function LevelBar({ studentId }) {
    ...
    const fetchProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LevelBar.useCallback[fetchProfile]": async ()=>{
            try {
                setLoading(true);
                ...
                if (prevLevelRef.current > 0 && data.current_level > prevLevelRef.current) {
                    setShowLevelUp(true);
                    setTimeout({
                        "LevelBar.useCallback[fetchProfile]": ()=>setShowLevelUp(false)
                    }["LevelBar.useCallback[fetchProfile]"], 2000);
                }
    ...
    }["LevelBar.useCallback[fetchProfile]"], [
        studentId,
        supabase
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LevelBar.useEffect": ()=>{
            ...
            return ({
                "LevelBar.useEffect": ()=>clearInterval(interval)
            })["LevelBar.useEffect"];
        }
    }["LevelBar.useEffect"], [
        fetchProfile
...
_s(LevelBar, "IPUwfu8t+U3diTKfRSxNHQHOE+k=");
_c = LevelBar;
...
function StudyMaterials({ materials, studentId, topicId, onXPEarned }) {
    _s1();
    ...
    const handleXPAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudyMaterials.useCallback[handleXPAction]": async (eventType, materialId, rpcFunction, xpAmount = 0)=>{
            ...
            try {
                ...
                setTimeout({
                    "StudyMaterials.useCallback[handleXPAction]": ()=>setShowXPPopup({
                            show: false,
                            xp: 0
                        })
                }["StudyMaterials.useCallback[handleXPAction]"], 1500);
                // Refresh level UI
                onXPEarned?.();
                toast({
                    title: "XP Earned!",
    ...
    }["StudyMaterials.useCallback[handleXPAction]"], [
        studentId,
        toast,
        onXPEarned,
        supabase
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: items.map((item)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(XPPopup, {
...
_s1(StudyMaterials, "3T7ajB3tYbuH/FSD+BVHY865gwk=", false, function() {
    return [
...
function TopicPage({ topicId, studentId }) {
    ...
    const [testScore, setTestScore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const fetchData = async ()=>{
        ...
        try {
            ...
            console.log("Topic Progress:", progressData);
        } catch (err) {
    ...
    const handleCompleteRevision = async (revNum)=>{
        try {
            ...
            await fetchData();
            setRefreshTrigger((t)=>t + 1); // Trigger level bar refresh
        } catch (err) {
    ...
    const totalXp = (topicProgress?.video_xp || 0) + (topicProgress?.test_xp || 0) + (topicProgress?.revision_xp || 0);
    const getRevisionStatus = (revision)=>{
        if (revision.is_completed) return {
            text: "Completed",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LevelBar, {
                studentId: studentId
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                            variant: getBadgeVariant(topicProgress?.status ?? null),
                                            children: topicProgress?.status || "Not Started"
                                        }, void 0, false, {
                                            fileName: "[project]/components/TopicPage.tsx",
                                            lineNumber: 929,
                                            columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StudyMaterials, {
                                ...
                                studentId: studentId,
                                topicId: topicId,
                                onXPEarned: ()=>setRefreshTrigger((t)=>t + 1)
                            }, void 0, false, {
                                fileName: "[project]/components/TopicPage.tsx",
                                lineNumber: 943,
                                columnNumber: 11
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Revise this topic to achieve mastery."
                                    }, void 0, false, {
                                        fileName: "[project]/components/TopicPage.tsx",
                                        lineNumber: 987,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "space-y-4",
                                children: revisionSchedule.length > 0 ? revisionSchedule.map((rev)=>{
...
_s2(TopicPage, "dNpboTVkyiMYVFSWsbNpEDyOdlM=");
_c3 = TopicPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "LevelBar");
__turbopack_context__.k.register(_c1, "XPPopup");
__turbopack_context__.k.register(_c2, "StudyMaterials");
__turbopack_context__.k.register(_c3, "TopicPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_4f11620d._.js.map