...
"[project]/app/mentor/command-center/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MentorCommandCenter() {
    ...
    const [mentorId, setMentorId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MentorCommandCenter.useEffect": ()=>{
            const load = {
                "MentorCommandCenter.useEffect.load": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const { data: assigned, error: aErr } = await supabase.from("student_mentor_assignments").select("student_id").eq("mentor_id", user.id).eq("is_active", true);
                        if (aErr) throw aErr;
                        if (!assigned || assigned.length === 0) {
                            setStudents([]);
                            return;
                        }
                        const studentIds = assigned.map({
                            "MentorCommandCenter.useEffect.load.studentIds": (x)=>x.student_id
                        }["MentorCommandCenter.useEffect.load.studentIds"]);
                        ...
                        const { data: levelData } = await supabase.from("level_system").select("student_id, total_xp, current_level").in("student_id", studentIds);
                        // 3. Student Profiles (accuracy, hours, streak)
                        const { data: studentProfiles } = await supabase.from("student_profiles").select("id, total_hours_studied, current_streak, overall_accuracy, last_study_date").in("id", studentIds);
                        const combined = profiles.map({
                            "MentorCommandCenter.useEffect.load.combined": (p)=>{
                                const lvl = levelData.find({
                                    "MentorCommandCenter.useEffect.load.combined": (l)=>l.student_id === p.id
                                }["MentorCommandCenter.useEffect.load.combined"]) || {};
                                const sp = studentProfiles.find({
                                    "MentorCommandCenter.useEffect.load.combined": (s)=>s.id === p.id
                                }["MentorCommandCenter.useEffect.load.combined"]) || {};
                                return {
                                    ...p,
                                    stats: {
            ...
            }["MentorCommandCenter.useEffect.load"];
            load();
        }
    }["MentorCommandCenter.useEffect"], []);
    const getHealthStatus = (stats)=>{
        ...
        if (accuracy >= 70 || streak >= 5) return {
            text: "Good",
            color: "bg-green-500"
        };
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mentor$2d$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MentorSidebar"], {}, void 0, false, {
                    fileName: "[project]/app/mentor/command-center/page.tsx",
                    lineNumber: 123,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Your assigned students & their overall performance."
                                }, void 0, false, {
                                    fileName: "[project]/app/mentor/command-center/page.tsx",
                                    lineNumber: 138,
                                    columnNumber: 13
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                        className: `${health.color} text-white px-2`,
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                            children: stats.last_study_date ? new Date(stats.last_study_date).toLocaleDateString() : "-"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/mentor/command-center/page.tsx",
                                                            lineNumber: 209,
                                                            columnNumber: 25
...
_s(MentorCommandCenter, "4k+g1m0giaNZ630AT8KmedpbNA8=", false, function() {
    return [
...
_c = MentorCommandCenter;
var _c;
__turbopack_context__.k.register(_c, "MentorCommandCenter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b3e66981._.js.map