...
"[project]/components/subjects-view.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SubjectsView() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubjectsView.useEffect": ()=>{
            const fetchData = {
                "SubjectsView.useEffect.fetchData": async ()=>{
                    setLoading(true);
                    ...
                    // Combine the data
                    const combinedData = subjectsData.map({
                        "SubjectsView.useEffect.fetchData.combinedData": (subject)=>{
                            const subjectTopics = topicsData.filter({
                                "SubjectsView.useEffect.fetchData.combinedData.subjectTopics": (topic)=>topic.subject_id === subject.id
                            }["SubjectsView.useEffect.fetchData.combinedData.subjectTopics"]).map({
                                "SubjectsView.useEffect.fetchData.combinedData.subjectTopics": (topic)=>{
                                    const progress = progressData.find({
                                        "SubjectsView.useEffect.fetchData.combinedData.subjectTopics.progress": (p)=>p.topic_id === topic.id
                                    }["SubjectsView.useEffect.fetchData.combinedData.subjectTopics.progress"]);
                                    return {
                                        ...topic,
                            ...
                            }["SubjectsView.useEffect.fetchData.combinedData.subjectTopics"]).sort({
                                "SubjectsView.useEffect.fetchData.combinedData.subjectTopics": (a, b)=>a.order_index - b.order_index
                            }["SubjectsView.useEffect.fetchData.combinedData.subjectTopics"]);
                            return {
                                ...subject,
                                topics: subjectTopics
                            };
                        }
                    }["SubjectsView.useEffect.fetchData.combinedData"]);
                    setSubjects(combinedData);
                    setLoading(false);
                }
            }["SubjectsView.useEffect.fetchData"];
            fetchData();
        }
    }["SubjectsView.useEffect"], []);
    if (loading) {
...
_s(SubjectsView, "OUMsFu3maVpcOO1Q7DqpvHiGZz8=");
_c = SubjectsView;
var _c;
__turbopack_context__.k.register(_c, "SubjectsView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_df526594._.js.map