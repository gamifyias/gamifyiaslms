...
;
;
// Study Materials Component with Test Score Submission
function StudyMaterials({ materials, studentId, topicId }) {
    ...
    // Fetch existing test scores
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudyMaterials.useEffect": ()=>{
            const fetchTestScores = {
                "StudyMaterials.useEffect.fetchTestScores": async ()=>{
                    setLoadingScores(true);
                    try {
                        const testMaterials = materials.filter({
                            "StudyMaterials.useEffect.fetchTestScores.testMaterials": (m)=>m.content_type === "test"
                        }["StudyMaterials.useEffect.fetchTestScores.testMaterials"]);
                        const scores = {};
                        for (const material of testMaterials){
                            const { data, error } = await supabase.from("tests").select("*").eq("student_id", studentId).eq("topic_id", topicId).eq("test_material_id", material.id).maybeSingle();
                            if (!error && data) {
                                scores[material.id] = data;
                            }
                        }
            ...
            }["StudyMaterials.useEffect.fetchTestScores"];
    ...
    const handleTestScoreChange = (materialId, value)=>{
        const numValue = value === "" ? 0 : Math.min(Math.max(parseInt(value) || 0, 0), 20);
        setTestInputs((prev)=>({
                ...prev,
                [materialId]: numValue
            }));
    };
    const handleSubmitTestScore = async (materialId)=>{
        ...
        try {
            ...
            // Fetch the newly submitted score
            const { data } = await supabase.from("tests").select("*").eq("student_id", studentId).eq("topic_id", topicId).eq("test_material_id", materialId).maybeSingle();
            if (data) {
                setTestScores((prev)=>({
                        ...prev,
                        [materialId]: data
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: items.map((item)=>{
                                const hasSubmittedScore = testScores[item.id];
                                const currentInput = testInputs[item.id];
                                const isSubmitting = submittingTests[item.id];
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isTestSection && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: hasSubmittedScore ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: [
                                                                    "Your Score: ",
                                                                    hasSubmittedScore.score,
                                                                    " / ",
                                                                    hasSubmittedScore.max_score
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/components/TopicPage.tsx",
                                                                lineNumber: 266,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: new Date(hasSubmittedScore.created_at).toLocaleDateString()
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/TopicPage.tsx",
                                                        lineNumber: 270,
                                                        columnNumber: 29
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        onClick: ()=>handleSubmitTestScore(item.id),
                                                        disabled: currentInput === undefined || currentInput === null || isSubmitting,
                                                        size: "sm",
...
_s(StudyMaterials, "tsaHmyd9PFvf400Jc0oQp4NMM08=");
_c = StudyMaterials;
...
_s1(TopicPage, "Zll7kjjGh8P4G7ohIGvMCnFB77c=");
_c1 = TopicPage;
var _c, _c1;
...
//# sourceMappingURL=_2eb3ff1d._.js.map