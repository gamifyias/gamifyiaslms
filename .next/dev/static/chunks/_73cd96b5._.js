...
"[project]/app/mentor/command-center/student-progress/progress-display.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProgressDisplay() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProgressDisplay.useEffect": ()=>{
            if (!studentId) {
                setLoading(false);
                return;
            }
            const load = {
                "ProgressDisplay.useEffect.load": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const topicIds = (topicsRes.data || []).map({
                            "ProgressDisplay.useEffect.load.topicIds": (t)=>t.id
                        }["ProgressDisplay.useEffect.load.topicIds"]);
            ...
            }["ProgressDisplay.useEffect.load"];
            load();
        }
    }["ProgressDisplay.useEffect"], [
        studentId
    ...
    const subjectBlocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProgressDisplay.useMemo[subjectBlocks]": ()=>{
            ...
            return subjects.map({
                "ProgressDisplay.useMemo[subjectBlocks]": (sub)=>{
                    const subTopics = topics.filter({
                        "ProgressDisplay.useMemo[subjectBlocks].subTopics": (t)=>t.subject_id === sub.id
                    }["ProgressDisplay.useMemo[subjectBlocks].subTopics"]);
                    const topicRows = subTopics.map({
                        "ProgressDisplay.useMemo[subjectBlocks].topicRows": (topic)=>{
                            ...
                            if (revs.length > 0) {
                                const completed = revs.filter({
                                    "ProgressDisplay.useMemo[subjectBlocks].topicRows.completed": (r)=>r.completed_date
                                }["ProgressDisplay.useMemo[subjectBlocks].topicRows.completed"]);
                                if (completed.length > 0) {
                                    completed.sort({
                                        "ProgressDisplay.useMemo[subjectBlocks].topicRows": (a, b)=>new Date(b.completed_date).getTime() - new Date(a.completed_date).getTime()
                                    }["ProgressDisplay.useMemo[subjectBlocks].topicRows"]);
                                    lastRevisionDate = completed[0].completed_date;
                                }
                            }
                            const completedRevisions = revs.filter({
                                "ProgressDisplay.useMemo[subjectBlocks].topicRows": (r)=>r.is_completed
                            }["ProgressDisplay.useMemo[subjectBlocks].topicRows"]).length;
                            return {
                                topicId: topic.id,
                    ...
                    const averageProgress = topicRows.length > 0 ? Math.round(topicRows.reduce({
                        "ProgressDisplay.useMemo[subjectBlocks]": (acc, t)=>acc + t.progress
                    }["ProgressDisplay.useMemo[subjectBlocks]"], 0) / topicRows.length) : 0;
                    return {
                        subject: sub,
                        topics: topicRows,
                        averageProgress
    ...
    const overallProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProgressDisplay.useMemo[overallProgress]": ()=>{
            if (!subjectBlocks.length) return 0;
            const total = subjectBlocks.reduce({
                "ProgressDisplay.useMemo[overallProgress].total": (sum, block)=>sum + block.averageProgress
            }["ProgressDisplay.useMemo[overallProgress].total"], 0);
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mentor$2d$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MentorSidebar"], {}, void 0, false, {
                    fileName: "[project]/app/mentor/command-center/student-progress/progress-display.tsx",
                    lineNumber: 251,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProgressDisplay, "tcAfFvi5N1TI1v9Ii7vkdgdCW6s=", false, function() {
    return [
...
//# sourceMappingURL=_73cd96b5._.js.map