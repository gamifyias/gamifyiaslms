...
async function StudentSubjectsPage() {
    ...
    if (!profile || profile.role !== "student") {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])("/student");
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SubjectsView, {}, void 0, false, {
                    fileName: "[project]/app/student/subjects/page.tsx",
                    lineNumber: 28,
                    columnNumber: 9
                }, this)
...
function SubjectsView() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubjectsView.useEffect": ()=>{
            const fetchSubjects = {
                "SubjectsView.useEffect.fetchSubjects": async ()=>{
                    try {
                        setLoading(true);
                        // Get current user
                        const { data: { user } } = await supabase.auth.getUser();
                        ...
                        const subjectsWithTopics = await Promise.all(subjectsData.map({
                            "SubjectsView.useEffect.fetchSubjects": async (subject)=>{
                                try {
                                    ...
                                    const topicIds = topicsData.map({
                                        "SubjectsView.useEffect.fetchSubjects.topicIds": (t)=>t.id
                                    }["SubjectsView.useEffect.fetchSubjects.topicIds"]);
                                    ...
                                    const topicsWithStats = topicsData.map({
                                        "SubjectsView.useEffect.fetchSubjects.topicsWithStats": (topic)=>{
                                            const progress = progressData?.find({
                                                "SubjectsView.useEffect.fetchSubjects.topicsWithStats": (p)=>p.topic_id === topic.id
                                            }["SubjectsView.useEffect.fetchSubjects.topicsWithStats"]);
                                            return {
                                                topicId: topic.id,
                                    ...
                                    const completedTopics = topicsWithStats.filter({
                                        "SubjectsView.useEffect.fetchSubjects": (t)=>t.status === "MASTERED"
                                    }["SubjectsView.useEffect.fetchSubjects"]).length;
                                    const averageProgress = topicsWithStats.length > 0 ? Math.round(topicsWithStats.reduce({
                                        "SubjectsView.useEffect.fetchSubjects": (sum, t)=>sum + t.progress
                                    }["SubjectsView.useEffect.fetchSubjects"], 0) / topicsWithStats.length) : 0;
                                    return {
                                        subject,
                        ...
                        }["SubjectsView.useEffect.fetchSubjects"]));
...
_s(SubjectsView, "wz2n+u2MozHldUtdF5t2gF8BpXQ=");
_c1 = SubjectsView;
var _c, _c1;
__turbopack_context__.k.register(_c, "StudentSubjectsPage");
__turbopack_context__.k.register(_c1, "SubjectsView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f08a10ce._.js.map