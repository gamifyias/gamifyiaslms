        ...
        "AdminDashboard.useEffect": ()=>{
            const fetchStats = {
                "AdminDashboard.useEffect.fetchStats": async ()=>{
                    ...
                    const totalStudents = usersResponse.data?.filter({
                        "AdminDashboard.useEffect.fetchStats": (p)=>p.role === "student"
                    }["AdminDashboard.useEffect.fetchStats"]).length || 0;
                    const totalMentors = usersResponse.data?.filter({
                        "AdminDashboard.useEffect.fetchStats": (p)=>p.role === "mentor"
                    }["AdminDashboard.useEffect.fetchStats"]).length || 0;
...
_s(AdminDashboard, "vY5m3sURrwSOCOVrCo6gb6VXGVM=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_c3007ae4._.js.map