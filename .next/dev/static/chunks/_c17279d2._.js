...
const TopicPage = ({ topicId, studentId, showSidebar = true })=>{
    ...
    const { tabs: allDojoTabs, refetchTabs, handleCompleteRevision: dojoHandleCompleteRevision } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDojo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDojo"])(studentId);
    const dojoTabs = {
    ...
    const fetchTopicData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TopicPage.useCallback[fetchTopicData]": async ()=>{
            setLoading(true);
            setError(null);
            try {
    ...
    }["TopicPage.useCallback[fetchTopicData]"], [
        supabase,
        topicId
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleXPAward = async (eventType, materialId, score)=>{
        try {
            const { xpEarned, leveledUp } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$xp$2f$awardXP$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["awardXP"])(eventType, materialId, studentId, topicId, score);
            if (xpEarned > 0) {
                setShowXPPopup({
                    show: true,
                    xp: xpEarned
...
_s1(TopicPage, "H4TrGXK816KNDY43lafQcX27mb4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
...
//# sourceMappingURL=_c17279d2._.js.map