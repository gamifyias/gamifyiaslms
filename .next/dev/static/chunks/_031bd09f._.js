                        ...
                        const subjectsWithTopics = await Promise.all(subjectsData.map({
                            "SubjectsPage.useEffect.fetchSubjects": async (subject)=>{
                                try {
                                    ...
                                    const { data: xpEventsData } = await supabase.from("xp_events").select("material_id, event_type").eq("student_id", user.id).in("material_id", (materialsData || []).map({
                                        "SubjectsPage.useEffect.fetchSubjects": (m)=>m.id
                                    }["SubjectsPage.useEffect.fetchSubjects"]));
                                    // FIXED: Fetch ALL test attempts and map latest by material
                                    const { data: testAttemptsData } = await supabase.from("tests").select("test_material_id, score, max_score, created_at").eq("student_id", user.id).in("test_material_id", (materialsData || []).filter({
                                        "SubjectsPage.useEffect.fetchSubjects": (m)=>m.content_type === "test"
                                    }["SubjectsPage.useEffect.fetchSubjects"]).map({
                                        "SubjectsPage.useEffect.fetchSubjects": (m)=>m.id
                                    }["SubjectsPage.useEffect.fetchSubjects"])).order("created_at", {
                                        ascending: false
                                    });
                                    // FIXED: Create a map of latest test score per material
                                    const latestTestByMaterial = new Map();
                                    testAttemptsData?.forEach({
                                        "SubjectsPage.useEffect.fetchSubjects": (attempt)=>{
                                    ...
                                    const topicsWithStats = topicsData.map({
                                        "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (topic)=>{
                                            ...
                                            const topicRevisions = revisionData?.filter({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (r)=>r.topic_id === topic.id
                                            }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats"]) || [];
                                            const completedRevisions = topicRevisions.filter({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (r)=>r.is_completed
                                            }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats"]).length;
                                            ...
                                            const latestRevision = topicRevisions.filter({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats.latestRevision": (r)=>r.completed_date
                                            }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats.latestRevision"]).sort({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats.latestRevision": (a, b)=>new Date(b.completed_date).getTime() - new Date(a.completed_date).getTime()
                                            }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats.latestRevision"]).at(0);
                                            const lastRevisionDate = latestRevision?.completed_date || null;
                                            // Get materials for this topic
                                            const topicMaterials = materialsData?.filter({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (m)=>m.topic_id === topic.id
                                            }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats"]) || [];
                                            ...
                                            topicMaterials.forEach({
                                                "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (material)=>{
                                                    if (material.content_type === "video" || material.content_type === "notes") {
                                                        ...
                                                        const hasAccessed = xpEventsData?.some({
                                                            "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (e)=>e.material_id === material.id && (e.event_type === "video_watch" || e.event_type === "note_read")
                                                        }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats"]);
                                                        ...
                                                        const hasAccessed = xpEventsData?.some({
                                                            "SubjectsPage.useEffect.fetchSubjects.topicsWithStats": (e)=>e.material_id === material.id
                                                        }["SubjectsPage.useEffect.fetchSubjects.topicsWithStats"]);
                                                        if (hasAccessed) materialsCompleted++;
                                                    }
                                                }
                                    ...
                                    const completedTopics = topicsWithStats.filter({
                                        "SubjectsPage.useEffect.fetchSubjects": (t)=>t.progress === 100
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                topic.hasStarted && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    className: "flex items-center gap-3 mb-2 text-xs",
                                                                                    children: [
                                                                                        topic.testScore > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=_031bd09f._.js.map