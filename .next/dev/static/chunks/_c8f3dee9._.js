...
"[project]/lib/questLog/questLogSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/QuestLog.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/questLog/questLogSystem.ts [app-client] (ecmascript)");
;
...
function QuestLog({ studentId }) {
    ...
    const [testScores, setTestScores] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [submittingTest, setSubmittingTest] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [completingRevision, setCompletingRevision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [expandedMaterials, setExpandedMaterials] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    ...
    const fetchQuests = async ()=>{
        try {
            ...
            const materialsMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchStudyMaterials"])(topicIds);
            // Build quest list
    ...
    const handleVideoClick = async (topicId, material)=>{
        try {
            ...
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleVideoComplete"])(studentId, topicId);
            if (updated) {
                // Update local state
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "video");
    ...
    const handlePDFClick = async (topicId, material)=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "pdf");
            window.open(material.resource_url, "_blank");
        } catch (err) {
    ...
    const handleTestClick = async (topicId, material)=>{
        try {
            // Update revision schedule
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "test");
            window.open(material.resource_url, "_blank");
        } catch (err) {
    ...
    const handleTestSave = async (topicId)=>{
        ...
        try {
            ...
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleTestSubmit"])(studentId, topicId, score);
            if (updated) {
                setQuests((prev)=>prev.map((q)=>q.topic.id === topicId ? {
                            ...q,
                            progress: updated
    ...
    const handleRevisionClick = async (topicId, revisionIndex)=>{
        ...
        try {
            ...
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleRevisionComplete"])(studentId, topicId, revisionIndex);
            if (updated) {
                setQuests((prev)=>prev.map((q)=>q.topic.id === topicId ? {
                            ...q,
                            progress: updated
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            p && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            expandedMaterials[quest.topic.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    p?.video_completed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    p?.test_completed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(QuestLog, "NtoxrwRTxcE5nYBCBr6bjrzycQg=");
_c = QuestLog;
var _c;
__turbopack_context__.k.register(_c, "QuestLog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function StudentSidebar() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentSidebar.useEffect": ()=>{
            let mounted = true;
            const loadProfile = {
                "StudentSidebar.useEffect.loadProfile": async ()=>{
                    try {
            ...
            }["StudentSidebar.useEffect.loadProfile"];
            loadProfile();
            return ({
                "StudentSidebar.useEffect": ()=>{
                    mounted = false;
...
_s(StudentSidebar, "64HCWxq+7b/wNTAbeYGp9zv6/Zc=", false, function() {
    return [
...
"[project]/app/student/quest-log/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/loader-circle.js [app-client] (ecmascript) <export default as Loader2>");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$QuestLog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/QuestLog.tsx [app-client] (ecmascript)");
...
function QuestLogPage() {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestLogPage.useEffect": ()=>{
            const getStudentId = {
                "QuestLogPage.useEffect.getStudentId": async ()=>{
                    try {
                        const { data: { user } } = await supabase.auth.getUser();
                        if (user?.id) {
            ...
            }["QuestLogPage.useEffect.getStudentId"];
            getStudentId();
        }
    }["QuestLogPage.useEffect"], [
        supabase
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$QuestLog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuestLog"], {
                        studentId: studentId
                    }, void 0, false, {
                        fileName: "[project]/app/student/quest-log/page.tsx",
                        lineNumber: 61,
...
_s(QuestLogPage, "9Fzi/n55vdA/zXg7ej7gph/90l0=");
_c = QuestLogPage;
var _c;
__turbopack_context__.k.register(_c, "QuestLogPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c8f3dee9._.js.map