...
"[project]/components/students-list.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StudentsList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentsList.useEffect": ()=>{
            const fetchStudents = {
                "StudentsList.useEffect.fetchStudents": async ()=>{
                    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
                    const { data } = await supabase.from("profiles").select("*").eq("role", "student").limit(20);
                    if (data) {
                        // Fetch student details
                        const studentDetails = await Promise.all(data.map({
                            "StudentsList.useEffect.fetchStudents": async (profile)=>{
                                const { data: studentData } = await supabase.from("student_profiles").select("total_points, current_level, overall_accuracy").eq("id", profile.id).single();
                                return {
                                    id: profile.id,
                                    ...
                                    overall_accuracy: studentData?.overall_accuracy || 0
                                };
                            }
                        }["StudentsList.useEffect.fetchStudents"]));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentsList.useEffect": ()=>{
            const filtered = students.filter({
                "StudentsList.useEffect.filtered": (student)=>student.full_name.toLowerCase().includes(searchTerm.toLowerCase()) || student.email.toLowerCase().includes(searchTerm.toLowerCase())
            }["StudentsList.useEffect.filtered"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        fileName: "[project]/components/students-list.tsx",
                        lineNumber: 73,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground mt-2",
                        children: "Track and manage your students' progress"
                    }, void 0, false, {
                        fileName: "[project]/components/students-list.tsx",
                        lineNumber: 74,
                        columnNumber: 9
...
_s(StudentsList, "/4eEE6+WMRTnf7iFhXrD5V21DU0=");
_c = StudentsList;
var _c;
...
//# sourceMappingURL=_df557f41._.js.map