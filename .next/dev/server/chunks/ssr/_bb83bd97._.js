...
"[project]/lib/questLog/questLogSystem.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getStatusFromXP = (totalXP)=>{
    if (totalXP >= 180) return "MASTERED";
    if (totalXP >= 120) return "GOOD";
    return "NEEDS_WORK";
};
const recalcProgress = (videoCompleted, testCompleted, rev1, rev2, rev3, rev4)=>{
    let progress = 0;
...
const getXPFromTestScore = (score)=>{
    if (score >= 16) return 50;
    if (score >= 11) return 25;
    if (score >= 7) return 10;
    return 0;
};
const ensureTopicProgress = async (studentId, topicId)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        // Check if exists
        const { data: existing, error: fetchError } = await supabase.from("topic_progress").select("*").eq("student_id", studentId).eq("topic_id", topicId).maybeSingle();
        ...
        const { data: newRow, error: insertError } = await supabase.from("topic_progress").insert({
...
const handleVideoComplete = async (studentId, topicId)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        ...
        const newProgressPercentage = recalcProgress(true, progress.test_completed, progress.revision_1_completed, progress.revision_2_completed, progress.revision_3_completed, progress.revision_4_completed);
        const { data: updated, error: updateError } = await supabase.from("topic_progress").update({
            video_xp: newVideoXP,
            total_xp: newTotalXP,
...
const handleTestSubmit = async (studentId, topicId, score)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        // Ensure progress exists
        let progress = await ensureTopicProgress(studentId, topicId);
        ...
        const newStatus = getStatusFromXP(newTotalXP);
        const newProgressPercentage = recalcProgress(progress.video_completed, true, progress.revision_1_completed, progress.revision_2_completed, progress.revision_3_completed, progress.revision_4_completed);
        const { data: updated, error: updateError } = await supabase.from("topic_progress").update({
            test_xp: newTestXP,
            total_xp: newTotalXP,
            test_score: score,
...
const handleRevisionComplete = async (studentId, topicId, revisionIndex)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        // Ensure progress exists
        let progress = await ensureTopicProgress(studentId, topicId);
        if (!progress) return null;
        const revisionKey = `revision_${revisionIndex}_completed`;
        const revisionDateKey = `revision_${revisionIndex}_date`;
        // If already completed, return as-is (idempotent)
        ...
        updateData.progress_percentage = recalcProgress(progress.video_completed, progress.test_completed, revisionIndex === 1 ? true : progress.revision_1_completed, revisionIndex === 2 ? true : progress.revision_2_completed, revisionIndex === 3 ? true : progress.revision_3_completed, revisionIndex === 4 ? true : progress.revision_4_completed);
        const { data: updated, error: updateError } = await supabase.from("topic_progress").update(updateData).eq("id", progress.id).select().maybeSingle();
        if (updateError) {
...
const openMaterial = async (studentId, topicId, materialType)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        // Check if entry exists
        const { data: existing } = await supabase.from("revision_schedule").select("*").eq("student_id", studentId).eq("topic_id", topicId).eq("material_type", materialType).maybeSingle();
        const now = new Date().toISOString();
        if (existing) {
...
const fetchStudyMaterials = async (topicIds)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        if (topicIds.length === 0) return new Map();
        const { data: materials, error } = await supabase.from("study_materials").select("id, topic_id, title, content_type, resource_url, duration_minutes").in("topic_id", topicIds);
        if (error) {
...
"[project]/components/QuestLog.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/questLog/questLogSystem.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function QuestLog({ studentId }) {
    ...
    const [testScores, setTestScores] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const [submittingTest, setSubmittingTest] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const [completingRevision, setCompletingRevision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const [expandedMaterials, setExpandedMaterials] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    ...
    const fetchQuests = async ()=>{
        try {
            ...
            setError(null);
            // Fetch all topics
            const { data: topics, error: topicsError } = await supabase.from("topics").select("id, name, description").order("created_at", {
                ascending: true
            });
            if (topicsError) throw new Error(topicsError.message);
            // Fetch all topic progress for this student
            const { data: progressData } = await supabase.from("topic_progress").select("*").eq("student_id", studentId);
            ...
            const materialsMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchStudyMaterials"])(topicIds);
            // Build quest list
            const questData = (topics || []).map((topic)=>({
                    topic,
    ...
    const handleVideoClick = async (topicId, material)=>{
        try {
            // Ensure progress exists and mark video complete
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleVideoComplete"])(studentId, topicId);
            if (updated) {
                // Update local state
                setQuests((prev)=>prev.map((q)=>q.topic.id === topicId ? {
                            ...q,
                            progress: updated
                        } : q));
                // Open material in new tab
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "video");
    ...
    const handlePDFClick = async (topicId, material)=>{
        try {
            // Update revision schedule
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "pdf");
            window.open(material.resource_url, "_blank");
        } catch (err) {
            console.error("Error opening PDF:", err);
        }
    };
    const handleTestClick = async (topicId, material)=>{
        try {
            // Update revision schedule
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "test");
            window.open(material.resource_url, "_blank");
        } catch (err) {
            console.error("Error opening test:", err);
        }
    };
    const handleTestScoreChange = (topicId, value)=>{
    ...
    const handleTestSave = async (topicId)=>{
        const score = testScores[topicId] || 0;
        try {
            setSubmittingTest((prev)=>({
                    ...prev,
                    [topicId]: true
                }));
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleTestSubmit"])(studentId, topicId, score);
            if (updated) {
                setQuests((prev)=>prev.map((q)=>q.topic.id === topicId ? {
                            ...q,
                            progress: updated
                ...
                const testMaterial = quests.find((q)=>q.topic.id === topicId)?.materials.find((m)=>m.content_type === "test");
                if (testMaterial) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openMaterial"])(studentId, topicId, "test");
    ...
    const handleRevisionClick = async (topicId, revisionIndex)=>{
        const key = `${topicId}-${revisionIndex}`;
        try {
            setCompletingRevision((prev)=>({
                    ...prev,
                    [key]: true
                }));
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$questLog$2f$questLogSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleRevisionComplete"])(studentId, topicId, revisionIndex);
            if (updated) {
                setQuests((prev)=>prev.map((q)=>q.topic.id === topicId ? {
                            ...q,
                            progress: updated
   ...
   */ const getStatusColor = (status)=>{
    ...
    const getMaterialIcon = (contentType)=>{
        if (contentType === "video") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$video$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Video$3e$__["Video"], {
            ...
            fileName: "[project]/components/QuestLog.tsx",
            lineNumber: 256,
            columnNumber: 41
        }, this);
    ...
    const completedQuests = quests.filter((q)=>q.progress && q.progress.progress_percentage === 100).length;
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardDescription"], {
                                children: "Track your progress on each topic"
                            }, void 0, false, {
                                fileName: "[project]/components/QuestLog.tsx",
                                lineNumber: 294,
                                columnNumber: 11
                                ...
                                children: [
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: quest.topic.description
                                                }, void 0, false, {
                                                    fileName: "[project]/components/QuestLog.tsx",
                                                    lineNumber: 338,
                                                    columnNumber: 21
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            p && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-xs text-muted-foreground",
                                                children: p.total_xp >= 180 ? "(Master Level)" : p.total_xp >= 120 ? "(Good Progress)" : "(Keep Going)"
                                            }, void 0, false, {
                                                fileName: "[project]/components/QuestLog.tsx",
                                                lineNumber: 359,
                                                columnNumber: 21
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    expandedMaterials[quest.topic.id] ? "Hide" : "Show",
                                                    " Study Materials (",
                                                    quest.materials.length,
                                                    ")"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/components/QuestLog.tsx",
                                            ...
                                            expandedMaterials[quest.topic.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "grid grid-cols-2 gap-2 ml-4",
                                                children: quest.materials.map((material)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                        variant: "outline",
                                                        size: "sm",
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    p?.video_completed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-1 text-green-700 text-sm font-semibold",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
                                                                className: "w-4 h-4"
                                                            }, void 0, false, {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    p?.test_completed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                ...
                                                                children: submittingTest[quest.topic.id] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            const isCompleted = p?.[`revision_${rev}_completed`];
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                ...
                                                                title: `Revision ${rev}`,
                                                                children: completingRevision[key] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                    className: "w-3 h-3 animate-spin"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/components/QuestLog.tsx",
                                                                    lineNumber: 484,
...
"[project]/app/student/quest-log/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/loader-circle.js [app-ssr] (ecmascript) <export default as Loader2>");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$QuestLog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/QuestLog.tsx [app-ssr] (ecmascript)");
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$student$2d$sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StudentSidebar"], {}, void 0, false, {
                    fileName: "[project]/app/student/quest-log/page.tsx",
                    lineNumber: 37,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: "Failed to load student ID"
                }, void 0, false, {
                    fileName: "[project]/app/student/quest-log/page.tsx",
                    lineNumber: 49,
                    columnNumber: 9
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$QuestLog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QuestLog"], {
                        studentId: studentId
                    }, void 0, false, {
                        fileName: "[project]/app/student/quest-log/page.tsx",
                        lineNumber: 61,
...
//# sourceMappingURL=_bb83bd97._.js.map