...
"[project]/components/XPPopup.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function XPPopup({ xp, show, duration = 1500 }) {
    const [isVisible, setIsVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(show);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (show) {
            setIsVisible(true);
...
"[project]/lib/dojo/dojoSystem.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        for (const materialType of materialTypes){
            try {
                ...
                const { data: existing, error: checkError } = await supabase.from("revision_schedule").select("id").eq("student_id", studentId).eq("topic_id", topicId).eq("material_type", materialType).eq("revision_number", 1).maybeSingle();
                // If already exists, skip
                if (existing) {
                    console.log(`Revision already exists for ${materialType}`);
                    continue;
                }
                // Create first revision
                const now = new Date();
                const dueDate = addDays(now, REVISION_INTERVALS[0]);
                const { error: insertError, data: insertData } = await supabase.from("revision_schedule").insert({
                    student_id: studentId,
                    topic_id: topicId,
                ...
                if (insertError) {
                    console.error(`Error creating first revision for ${materialType}:`, {
                    ...
                    console.log(`First revision created for ${materialType}:`, insertData);
                }
            } catch (err) {
                console.error(`Exception creating revision for ${materialType}:`, err);
            }
        }
    } catch (err) {
        console.error("Error in startTopicProgress:", err);
    }
};
const openMaterial = async (topicId, studentId, materialType)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        // Find the active (non-completed) revision
        const { data: revision, error: fetchError } = await supabase.from("revision_schedule").select("*").eq("student_id", studentId).eq("topic_id", topicId).eq("material_type", materialType).eq("is_completed", false).order("revision_number", {
            ascending: false
        }).maybeSingle();
        if (fetchError) {
            console.error("Error fetching revision:", {
                code: fetchError.code,
                message: fetchError.message,
                details: fetchError.details
            });
            // If no entry exists at all, create first revision
            if (fetchError.code === "PGRST116" || !revision) {
                console.log(`No revision found for ${materialType}, creating first revision`);
                await startTopicProgress(topicId, studentId, [
                    materialType
                ]);
                return openMaterial(topicId, studentId, materialType);
            }
            return null;
        }
        if (!revision) {
            console.log(`No active revision found, creating first revision`);
            await startTopicProgress(topicId, studentId, [
                materialType
            ]);
            return openMaterial(topicId, studentId, materialType);
        ...
        if (updateError) {
            console.error("Error updating last_opened_at:", {
                code: updateError.code,
                message: updateError.message
            });
            return null;
        }
        console.log(`Updated last_opened_at for revision ${revision.id}`);
        return revision;
    } catch (err) {
        console.error("Exception in openMaterial:", err);
        return null;
    }
};
const completeRevision = async (revisionId, studentId)=>{
    ...
    try {
        // Fetch the revision
        const { data: revision, error: fetchError } = await supabase.from("revision_schedule").select("*").eq("id", revisionId).single();
        if (fetchError) {
        ...
        if (completeError) {
            console.error("Error completing revision:", completeError);
            return false;
        }
        // Create next revision if not the last one
        if (revision.revision_number < 4) {
            const nextRevNumber = revision.revision_number + 1;
            const nextDueDate = addDays(new Date(), REVISION_INTERVALS[nextRevNumber - 1]);
            ...
            if (nextError) {
                console.error("Error creating next revision:", nextError);
            }
        }
        // Award 10 XP for revision completion
...
const awardRevisionXP = async (studentId)=>{
    ...
    try {
        ...
        const oldLevel = levelData?.current_level || 1;
        ...
        if (updateError) {
            console.error("Error updating level system:", updateError);
            return;
        }
        ...
        console.error("Error in awardRevisionXP:", err);
    }
};
const fetchDojoTabs = async (studentId)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        const { data: revisions, error } = await supabase.from("revision_schedule").select("*").eq("student_id", studentId).eq("is_completed", false).order("due_date", {
            ascending: true
        });
        if (error) {
            console.warn("Error fetching revisions:", {
                code: error.code,
        ...
        console.error("Error in fetchDojoTabs:", err);
        return {
            overdue: [],
            today: [],
            upcoming: []
...
const fetchAllRevisions = async (studentId)=>{
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    try {
        const { data: revisions, error } = await supabase.from("revision_schedule").select("*").eq("student_id", studentId).order("due_date", {
            ascending: true
        });
        if (error) {
        ...
        console.error("Error in fetchAllRevisions:", err);
        return [];
    }
};
}),
"[project]/hooks/useDojo.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dojo/dojoSystem.ts [app-ssr] (ecmascript)");
;
;
const useDojo = (studentId)=>{
    ...
    const fetchTabs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setLoading(true);
            const dojoTabs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchDojoTabs"])(studentId);
            setTabs(dojoTabs);
        } catch (err) {
            console.error("Error fetching DOJO tabs:", err);
            setError("Failed to load DOJO revisions");
        } finally{
            setLoading(false);
        }
    }, [
    ...
    const handleCompleteRevision = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (revisionId)=>{
        try {
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["completeRevision"])(revisionId, studentId);
            if (success) {
                await fetchTabs(); // Refresh tabs
            }
            return success;
        } catch (err) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$XPPopup$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/XPPopup.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$xp$2f$awardXP$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/xp/awardXP.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dojo/dojoSystem.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDojo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useDojo.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function StudyMaterials({ materials, studentId, topicId, onXPAward, onOpenMaterial }) {
    ...
    // Handle opening any material with XP award and DOJO tracking
    const handleOpenMaterial = async (materialId, contentType)=>{
        ...
        try {
            // Update DOJO revision tracking - creates entry if not exists
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openMaterial"])(topicId, studentId, materialType);
            // Award XP
...
function TopicPage({ topicId, studentId }) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const { tabs: dojoTabs, handleCompleteRevision, refetchTabs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDojo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDojo"])(studentId);
    const fetchData = async ()=>{
        ...
        try {
            ...
            if (materialsData && materialsData.length > 0) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dojo$2f$dojoSystem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startTopicProgress"])(topicId, studentId, materialTypes).catch((err)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$XPPopup$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["XPPopup"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "space-y-4",
                                children: [
                                    dojoTabs.overdue.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2",
                                    ...
                                    dojoTabs.today.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2",
                                    ...
                                    dojoTabs.upcoming.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2",
                                    ...
                                    dojoTabs.overdue.length === 0 && dojoTabs.today.length === 0 && dojoTabs.upcoming.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=_1aa21ce3._.js.map