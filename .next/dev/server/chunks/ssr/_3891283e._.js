...
function StudyMaterials({ materials, studentId, topicId, onXPAward }) {
    ...
    const handleVideoWatch = async (materialId, _isRewatch = false)=>{
        // Call parent handler which uses new React XP system
        await onXPAward(_isRewatch ? "video_rewatch" : "video_watch", materialId);
    };
    // Handle note read with new XP system
    const handleReadNote = async (materialId, _isRevise = false)=>{
        // Call parent handler which uses new React XP system
        await onXPAward(_isRevise ? "note_revise" : "note_read", materialId);
    };
    ...
    const handleTestScoreSubmitWithXP = async (materialId, score, isRetest = false)=>{
        ...
        try {
            ...
            // Award XP using new React system
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Study all available materials above"
                                        }, void 0, false, {
                                            fileName: "[project]/components/TopicPage.tsx",
                                            lineNumber: 663,
                                            columnNumber: 15
...
//# sourceMappingURL=_3891283e._.js.map