    ...
    try {
        for (const materialType of materialTypes){
            try {
                ...
                const { data: existing } = await supabase.from("revision_schedule").select("id").eq("student_id", studentId).eq("topic_id", topicId).eq("material_type", materialType).eq("revision_number", 1).maybeSingle();
...
const openMaterial = async (topicId, studentId, materialType)=>{
    ...
    try {
        ...
        const { data: revision } = await supabase.from("revision_schedule").select("*").eq("student_id", studentId).eq("topic_id", topicId).eq("material_type", materialType).eq("is_completed", false).order("revision_number", {
            ascending: false
        }).maybeSingle();
        if (!revision) {
        ...
        console.warn("Warning in openMaterial:", err);
        return null;
    }
};
const completeRevision = async (revisionId, studentId)=>{
    ...
    try {
        ...
        if (completeError) {
            console.warn("Error completing revision:", completeError);
            return false;
        }
...
"[project]/app/student/subjects/[topicId]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/loader-circle.js [app-ssr] (ecmascript) <export default as Loader2>");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TopicPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/TopicPage.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function TopicDetailPage() {
    ...
    if (!studentId || !topicId) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "text-center text-destructive p-6",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TopicPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TopicPage"], {
        topicId: topicId,
        studentId: studentId
    }, void 0, false, {
        fileName: "[project]/app/student/subjects/[topicId]/page.tsx",
...
//# sourceMappingURL=_e74d892c._.js.map